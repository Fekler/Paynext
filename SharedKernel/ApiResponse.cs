...
namespace SharedKernel
{
    public class ApiResponse<T>
    {
        ...
        public ApiResponse<T> Success(T data, string? message = null)
        {
    ...
    public class Response<T>
    {
        ...
        public Response<T> Success(T data, string? message = null, HttpStatusCode? statusCode = null)
        {
            message = message is not null ? message : "System success";
            StatusCode = statusCode is null ? HttpStatusCode.OK : statusCode.Value;
            ApiReponse = new ApiResponse<T>().Success(data, message);
            return this;
        }
